...
AFRAME.registerPrimitive('a-inferno', {
    defaultComponents: {
      inferno: {}
    },
    mappings: {
      radius: 'inferno.radius',
      detail: 'inferno.detail',
      opcity: 'inferno.opcity',
    }
});

AFRAME.registerComponent('inferno', {
      ...
      material.material = new THREE.ShaderMaterial( {
        vertexShader: [
          ...
          'void main() {',
            ...
            'noise =  -0.10 * turbulence( .5 * normal + time );',
            'float b = .25 * pnoise( 0.005 * position + vec3( 2.0 * time ), vec3( 100.0 ) );',
        ...
        fragmentShader: [
          ...
          'void main() {',
              ...
              'float r = .01 * random( vec3( 12.9898, 78.233, 151.7182 ), '+ Math.random() +' );',
              'vec2 tPos = vec2( 0, 1.0 - 30.0 * noise + r );',
              'vec4 color = texture2D( tExplosion, tPos );',
              'gl_FragColor = vec4( color.rgb, '+ data.opacity +' );',
